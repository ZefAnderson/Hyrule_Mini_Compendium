...
export interface CreatureEntry extends BaseEntry {
     ...
     * @readonly
     */
    readonly cooking_effect?: "" | "extra hearts" | "stamina recovery" | "heat resistance" | "cold resistance" | "shock resistance" | "stealth up" | "attack up" | "defense up" | "flame guard" | "speed up" | "extra stamina";
}
/**
 ...
 */
export declare type EntryType = string | number;
/**
 * @alias AnyEntry Represents an entry of any category
 */
export declare type AnyEntry = CreatureEntry | EquipmentEntry | MaterialEntry | MonsterEntry | TreasureEntry;
/**
 * @alias AnyCategory Represents any category
 */
export declare type AnyCategory = AnyEntry[] | {
    food: CreatureEntry[];
    non_food: CreatureEntry[];
};
/**
 ...
 * @returns {AnyCategory}
 */
export declare function type_category(category_data: AnyCategory): AnyCategory;
/**
 ...
 */
export declare class EntryImage {
     ...
     */
    get_stream(callback: ImageGetStreamCallback, timeout?: number, error_callback?: Function): void;
    /**
